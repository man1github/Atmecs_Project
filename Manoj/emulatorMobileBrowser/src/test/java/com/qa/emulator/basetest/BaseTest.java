...
public class BaseTest {
	...
	public static ExtentTest test;	
	  ...
	  @BeforeSuite
		@Parameters({ "platformName", "deviceName", "udid", "browserName"})
		public static void setCapabilites(String platformName, String deviceName, String udid, String browserName) {
			try {
...
//				ReusableMethods.keyboardEvents(KeyEvent.VK_ALT, KeyEvent.VK_TAB);
				...
				uiAutomator2Options.setCapability("browserName", browserName);
				uiAutomator2Options.setCapability("automationName", "UiAutomator2");
				uiAutomator2Options.setCapability("chromedriverExecutable", "C:\\Users\\manoj.mukannan\\Downloads\\chromedriver_win32 (1)\\chromedriver.exe");
